...
<img src="{{ asset('images/logo-dinamia.jpeg') }}" alt="DINAMIA Logo" height="55" class="me-2 d-inline-block align-text-top animate-float">                    
                ...
                <p class="opacity-75">Gestión cultural, eventos y activación rural en el <strong>Camín Real de la Mesa</strong>. Un proyecto para crear comunidad y combatir la despoblación.</p>
            </div>
            ...
            <div class="col-lg-3">
                ...
                <p class="opacity-75"><i class="fa-solid fa-envelope me-2" style="color: var(--dinamia-blue-light);"></i> laura@dinamiactiva.com</p>
                 <p class="opacity-75"><i class="fa-solid fa-masks-theater me-2" style="color: var(--dinamia-blue-light);"></i> +34 649 59 75 56</p>
            </div>
        </div>
        <hr class="border-light my-5 opacity-25">
        <div class="text-center small opacity-50">
            © 2026 DINAMIA Gestión Sociocultural.
        </div>
    </div>
</footer>